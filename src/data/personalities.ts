...
export const PERSONALITIES: Record<PersonalityId, PersonalityInfo> = {
  ...
  militarist: { id: 'militarist', name: 'Militarista', description: 'Mantém exércitos enormes e resolve disputas pela força.', aggression: 0.62, militaryBudget: 0.34, allianceSeek: 0.4, tradeSeek: 0.2, opportunism: 0.45, peaceWillingness: 0.3, coalitionJoin: 0.4, annexation: 0.4, isolation: 0.2 },
  ...
  opportunist: { id: 'opportunist', name: 'Oportunista', description: 'Ataca quem estiver fraco ou distraído em outras guerras.', aggression: 0.42, militaryBudget: 0.18, allianceSeek: 0.45, tradeSeek: 0.45, opportunism: 0.95, peaceWillingness: 0.5, coalitionJoin: 0.55, annexation: 0.35, isolation: 0.2 },
};
